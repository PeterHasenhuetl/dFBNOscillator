function get_default_annotation_rotated(x_pos, y_pos, my_text, text_color, font_angle, horizontal_alignment)
...
annotation('textbox', 'Units', 'centimeters', 'Position', [x_pos+0.2, y_pos-0.25, 10, 0.25], ...
    ...
    'HorizontalAlignment', horizontal_alignment, 'Rotation', 90)
